...
export const MOROCCO_REGION_FIXTURES = [
  { code: 'MRR', nameFr: 'Marrakech-Safi', nameAr: 'مراكش-آسفي' },
  { code: 'SFI', nameFr: 'Souss-Massa', nameAr: 'سوس-ماسة' },
  { code: 'DKH', nameFr: 'Drâa-Tafilalet', nameAr: 'درعة-تافيلالت' },
  { code: 'FES', nameFr: 'Fès-Meknès', nameAr: 'فاس-مكناس' },
  { code: 'TNG', nameFr: 'Tanger-Tétouan-Al Hoceïma', nameAr: 'طنجة-تطوان-الحسيمة' },
];
