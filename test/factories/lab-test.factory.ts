...
export function buildLabTestEvent(overrides: Record<string, unknown> = {}) {
  return {
    ...
    productName: faker.helpers.arrayElement(['Huile d\'Argan', 'Safran de Taliouine', 'Huile d\'Olive Picholine']),
    ...
    labName: faker.helpers.arrayElement(['Laboratoire Officiel ONSSA Agadir', 'LCM Casablanca', 'LPEE Marrakech']),
    parameters: {},
    ...overrides,
  };
}
